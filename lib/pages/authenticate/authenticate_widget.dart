...
class AuthenticateWidget extends StatefulWidget {
  const AuthenticateWidget({
    ...
    bool? showPasswordReset,
        ...
        this.showPasswordReset = showPasswordReset ?? false,
        super(key: key);
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'a2ts2pga' /* Or use a social account */,
                                  ),
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: Text(
                                            'Sorry about this but Login with Google is not available yet'),
                                        actions: [
                                          TextButton(
                                ...
                                onTap: () async {
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text(
                                            'Login with Apple unavailable'),
                                        content: Text(
                                            'Sorry about this but Login with Apple Auth is not available yet'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                                ...
                                onTap: () async {
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text(
                                            'Login with Facebook unavailable'),
                                        content: Text(
                                            'Sorry about this but Login with Facebookis not available yet'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                                ...
                                onTap: () async {
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text(
                                            'Login with Phone unavailable'),
                                        content: Text(
                                            'Sorry about this but Login with Phone is not available yet'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 10.0, 0.0, 10.0),
                          child: FFButtonWidget(
                            onPressed: (_model.userTypeValue != null &&
                                ...
                                ? null
                                : () async {
                                    if (FFAppState().AnonymousUserLogin.email !=
                                            null &&
                                      ...
                                      FFAppState().AnonymousUserLogin =
                                          AnonymousUserLoginStruct(
                                        email: '${random_data.randomString(
                                          10,
                                          20,
                                          true,
                                          true,
                                      ...
                                      context.pushNamedAuth(
                                          'UserInfo', context.mounted);
                                    }

                                    FFAppState().anonymous = true;
                                  },
                            text: FFLocalizations.of(context).getText(
                              'aa82bfen' /* Use anonymously */,
                            ),
                            icon: FaIcon(
