                            ...
                            onTap: () async {
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title:
                                        Text('Login with Google unavailable'),
                                    content: Text(
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Login with Apple unavailable'),
                                    content: Text(
                            ...
                            onTap: () async {
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title:
                                        Text('Login with Facebook unavailable'),
                                    content: Text(
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Login with Phone unavailable'),
                                    content: Text(
                        ...
                        onPressed: (_model.userTypeValue != null &&
                            ...
                            : () async {
                                if (FFAppState().AnonymousUserLogin.email !=
                                  ...
                                  if (FFAppState().AnonymousUserLogin.pass !=
