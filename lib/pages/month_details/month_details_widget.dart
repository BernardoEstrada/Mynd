                ...
                child: FutureBuilder<List<AttackReportsRow>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Column(
                      ...
                      children: List.generate(columnAttackReportsRowList.length,
                          (columnIndex) {
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FaIcon(
                                      ...
                                      color: () {
                                        if (columnAttackReportsRow.rate < 20) {
                                          return FlutterFlowTheme.of(context)
                                              .secondary;
                                        } else if (columnAttackReportsRow.rate <
                                            50) {
                                          return FlutterFlowTheme.of(context)
                                              .warning;
                                        } else {
                                    ...
                                    if (columnAttackReportsRow.notes != null &&
